...
@Service
public class CancellationRequestInitiationService {
	...
	public CancellationRequestInitiationService(AvailabilityPersistenceCoordinator persistence,
	...
	public CancellationRequestResponse initiate(String dni, String recaptchaToken, String correlationId) {
		try {
		...
		catch (CancellationRequestProtectedException | AvailabilityCheckInProgressException | AvailabilityUnavailableException
			...
			throw new CancellationRequestConcurrencyException(exception);
		}
	}
