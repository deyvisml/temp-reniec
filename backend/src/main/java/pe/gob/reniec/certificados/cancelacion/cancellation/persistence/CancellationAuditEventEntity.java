...
public class CancellationAuditEventEntity {
	...
	@Column(name = "external_reference", updatable = false, length = 128)
	private String externalReference;

	@Column(name = "technical_code", updatable = false, length = 64)
	private String technicalCode;

	@Column(name = "technical_detail", updatable = false, length = 255)
	...
	public CancellationAuditEventEntity(CertificateCancellationRequestEntity request,
			...
			String externalReference, String technicalCode, String technicalDetail,
