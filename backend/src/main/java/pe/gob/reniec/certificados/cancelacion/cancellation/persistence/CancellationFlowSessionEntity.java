...
@Entity
@Table(name = "cancellation_flow_session")
public class CancellationFlowSessionEntity {
	...
	protected CancellationFlowSessionEntity() { }

	public CancellationFlowSessionEntity(CertificateCancellationRequestEntity request, String refreshHash,
