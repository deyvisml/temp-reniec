...
public class IdentityVerificationController {
	...
	private static pe.gob.reniec.credenciales.revocacion.revocation.session.FlowSessionException unauthorized() {
		return new pe.gob.reniec.credenciales.revocacion.revocation.session.FlowSessionException(
				pe.gob.reniec.credenciales.revocacion.revocation.session.FlowSessionException.Reason.REQUIRED);
	}
