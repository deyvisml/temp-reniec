...
@Entity
@Table(name = "digital_credential_revocation_request")
public class DigitalCredentialRevocationRequestEntity {
	...
	private RevocationRequestStatus requestStatus;
	...
	private RevocationFinalOutcome finalOutcome;
	...
	@Transient
	private RevocationReasonCode persistedReason;
	...
	protected DigitalCredentialRevocationRequestEntity() {
	}

	public DigitalCredentialRevocationRequestEntity(String dni) {
		this.dni = requireDni(dni);
		this.requestStatus = RevocationRequestStatus.STARTED;
		this.availabilityResult = CurrentAvailabilityResult.NOT_CHECKED;
	}

	public void recordAvailability(CurrentAvailabilityResult result, RevocationRequestStatus status) {
	...
	public void beginAvailabilityCheck() {
		requestStatus = RevocationRequestStatus.CHECKING_AVAILABILITY;
	}

	public void confirmDecision(RevocationReasonCode reason, String description,
		...
		requestStatus = RevocationRequestStatus.CONFIRMED;
	}

	public void transitionTo(RevocationRequestStatus status, RevocationFinalOutcome outcome) {
		requestStatus = Objects.requireNonNull(status, "status");
	...
	private void validate() {
		...
		if (reasonCode == RevocationReasonCode.OTHER) requireBoundedText(otherReason, "otherReason", 300);
	...
	public RevocationRequestStatus getRequestStatus() { return requestStatus; }
	public CurrentAvailabilityResult getAvailabilityResult() { return availabilityResult; }
	public RevocationReasonCode getReasonCode() { return reasonCode; }
	public String getOtherReason() { return otherReason; }
	public Instant getConfirmedAt() { return confirmedAt; }
	public String getConsentVersion() { return consentVersion; }
	public RevocationFinalOutcome getFinalOutcome() { return finalOutcome; }
