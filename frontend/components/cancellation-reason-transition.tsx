...
import type { CancellationReasonCode } from "@/lib/api/cancellation-confirmation";
...
export function CancellationReasonTransition({
  reason,
  otherReason,
  onReasonChange,
  onOtherReasonChange,
  ...
  otherReason: string;
  onReasonChange: (reason: CancellationReasonCode) => void;
