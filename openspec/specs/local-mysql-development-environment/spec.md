# Local MySQL Development Environment Specification

## Purpose

Define a repeatable, local-only MySQL environment that contributors can start quickly with Docker Compose and share with the Spring Boot local profile without committing private environment files.
